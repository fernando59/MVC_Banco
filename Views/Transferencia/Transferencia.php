...
<div class="form-group row">
   ...
   <div class="col-sm-10">
   <input type="text" class="form-control" id="transferencia_cuenta_origen" placeholder="Buscar" data-toggle="modal" data-target="#modalCuentaOrigen" onclick="getCuentaPropia()" readonly>
...
<div class="form-group row">
   ...
   <div class="col-sm-10">
  <input type="text" class="form-control" id="transferencia_cuenta_destino" placeholder="Buscar" data-toggle="modal" data-target="#modalCuentaDestino" readonly  onclick="getCuentaDeposito()">
...
var listarCuentaOrigen = function(){
    ...
    var insertar = function(){
            ...
            $.ajax({
                ...
                type:"POST",
                data:{cuenta_origen,cuenta_destino,monto,tipo_moneda,glosa,fondo_origen,fondo_destino,cliente_id},
                success:function(data){
                   console.log(data)
                  swal({
                title: "Creado!",
      ...
      $.ajax({
          ...
          success:function(data){
            ...
            for(let i =  0; i<json.length; i++){
                 ...
                 raw += "<tr><td>"+json[i].nroCuenta+"</td><td>"+json[i].saldo+"</td><td>"+json[i].tasaInteresId+"</td></tr>"
            }
      ...
      $.ajax({
          ...
          success:function(data){
            ...
            for(let i =  0; i<json.length; i++){
                 ...
                 raw += "<tr><td>"+json[i].idCuentaDeposito+"</td><td>"+json[i].nroCuenta+"</td><td>"+json[i].fecha_registro+"</td></tr>"
            }
